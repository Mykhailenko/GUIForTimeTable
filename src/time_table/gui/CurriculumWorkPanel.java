...
public class CurriculumWorkPanel extends JPanel{
	private static final long serialVersionUID = 1L;
	static private StoreCurriculumModels m;
	
	public   CurriculumWorkPanel(StoreCurriculumModels model){
		m = model;
		m.initData();
		...
		save = new JButton("<html>Загрузить<p>уч.план</html>", new ImageIcon("images/загрузка.png"));
		delete = new JButton("<html>Удалить<p>уч.план</html>", new ImageIcon("images/удаление.png"));
				...
				if (Dispatcher.safetyDevice()==true)
					...
					JOptionPane
							.showMessageDialog(null,
									"Определите служебную информацию. (Меню 'Установки -> Специальность')");
			};
		});
